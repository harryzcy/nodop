  ...
  if (typeof value === 'object') {
    ...
    if (e.property.type === 'call_expression') {
      ...
      if (value[e.property.func] instanceof AsyncFunction) {
        // eslint-disable-next-line @typescript-eslint/no-unsafe-return, @typescript-eslint/return-await, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access
